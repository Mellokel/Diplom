//
// EtalonWithVariationsAndPricesGetApiModel.swift
//
...
open class EtalonWithVariationsAndPricesGetApiModel: Codable {

    public var variations: [EtalonVariationWithPriceGetApiModel]?
    public var id: Int?
    ...
    public init(variations: [EtalonVariationWithPriceGetApiModel]?, id: Int?, name: String?, description: String?, article: String?, imageId: UUID?, commodityCategoryId: Int?, supplierCategoryId: Int?, manufacturingMargin: Double?, storageMargin: Double?, currencyId: Int?, orderUnitId: Int?, quantityMinimum: Double?, quantityStep: Double?, quantityMaximum: Double?, disabled: Bool?, options: [String:Any]?) {
    ...
    public required init(from decoder: Decoder) throws {
        ...
        variations = try container.decodeIfPresent([EtalonVariationWithPriceGetApiModel].self, forKey: "Variations")
